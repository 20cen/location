...
<div class="row layout-top-spacing">
    <div class="col-md-2 widget widget-account-invoice-one">
        ...
        <div class="widget-content">
            <div class="invoice-box">
                ...
                <div class="acc-total-info">
                    <h5>Total</h5>
                    <p class="acc-amount">{{ (int)$adminds + (int)$clients }}</p>
                </div>
                ...
                <div class="inv-action">
                    <a href="{{ route('user.index') }}" class="btn btn-dark btn-block">Détails</a>
    ...
    <div class="col-md-2 widget widget-account-invoice-one">
        ...
        <div class="widget-content">
            <div class="invoice-box">
                ...
                <div class="inv-action">
                    <a href="{{ route('materiel.index') }}" class="btn btn-danger btn-block">Détails</a>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-2 widget widget-account-invoice-one ">
        ...
        <div class="widget-content">
            <div class="invoice-box">
                ...
                <div class="acc-total-info">
                    <h5>Total</h5>
                    <p class="acc-amount">{{ (int)$stcks + (int)$pertes }}</p>
                </div>
                ...
                <div class="inv-action">
                    <a href="{{ route('stock.index') }}" class="btn btn-dark btn-block">Détails</a>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-2 widget widget-account-invoice-one ">
        ...
        <div class="widget-content">
            <div class="invoice-box">
                ...
                <div class="inv-action">
                    <a href="{{ route('location.index') }}" class="btn btn-danger btn-block">Détails</a>
                </div>
            </div>
        </div>
