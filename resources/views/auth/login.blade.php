...
<head>
    ...
    <link href="{{asset('resources/assets/css/authentication/form-2.css')}}" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <link rel="stylesheet" type="text/css" href="{{asset('resources/assets/css/forms/theme-checkbox-radio.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('resources/assets/css/forms/switches.css')}}">
    <style>
        body{
...
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">GORDON SERVICES</h1>
                        <p class="">Veuillez vous connecter</p>
                            ...
                            <div class="form">
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{route('password.request')}}" class="forgot-pass-link">Mot de passe publié?</a>
                                    </div>
    ...
    <script src="{{asset('resources/assets/js/authentication/form-2.js')}}"></script>
